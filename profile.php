                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <br> 
                            <?php
                            echo "<img src='../img/".$row['profile']."' style='height: 280px;' class='col-md-5 my-2'>";
                            ?>
                      ...
                      <div class="col-md-6">
                        ...
                        if(isset($_POST['change_uname'])){
                            ...
                            if (empty($uname)){
                                // Handle case when username is empty
                            } else {
                        ...
                        if(isset($_POST['change_pass'])){
                             ...
                             if($old != $row['password']){
                                // Handle case when old password doesn't match
                             } else if(empty($new)){
                                // Handle case when new password is empty
                             } else if($con != $new){
                                // Handle case when new password and confirm password don't match
                             } else {
